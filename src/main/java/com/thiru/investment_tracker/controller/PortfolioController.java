...
public class PortfolioController {
    ...
    public ResponseEntity<ProfitAndLossResponse> getProfitAndLoss(@PathVariable String email, @RequestParam String financialYear) {
    ...
    public ResponseEntity<List<AssetResponse>> getAllStocks(@PathVariable String email, @RequestBody BulkGetRequest bulkGetRequest) {
    ...
    public ResponseEntity<List<Asset>> testRequest(@PathVariable String email, @RequestBody BulkGetRequest bulkGetRequest) {
