...
public class PortfolioService {
    ...
    public void buyStock(UserMail userMail, AssetRequest assetRequest) {
        ...
        Optional<Asset> optionalStock =
                portfolioRepository.findByEmailAndStockCodeAndTransactionDate(email, stockCode, transactionDate);
        Asset asset;
    ...
    public void sellStock(UserMail userMail, AssetRequest assetRequest) {
        ...
        List<Asset> stockEntities =
                portfolioRepository.findByEmailAndStockCodeOrderByTransactionDate(email, stockCode);
    ...
    public List<AssetResponse> getAllStocks(UserMail userMail) {
        ...
        List<AssetResponse> responseEntities =
                CommonUtil.map(stockEntityMap.values(), PortfolioService::combineAllDetailsOfEntities);
    ...
    public List<AssetResponse> getStocksWithDateRange(UserMail userMail, Date startDate, Date endDate) {
        ...
        List<Asset> stockEntities = portfolioRepository
                .findByEmailAndTransactionDateBetween(email, startDate, endDate);
    ...
    /**
     * A method that combines all details of stock entities to single entity based on a given stock code.
     *
     * @param stockEntities a list of stock entities to search through* @return the response entity that matches the provided stock code
     */
