...
public class ProfitAndLossService {
   ...
   /**
     ...
     *       using {@link #updateProfitAndLossReports(com.thiru.investment_tracker.entity.ProfitAndLossEntity, InternalContext)}.</li>
     ...
     * @deprecated for removal; use {@link #updateProfitAndLoss(UserMail, ProfitAndLossContext, String)} instead
     */
    ...
    private static void updateProfitAndLossReports1(ProfitAndLossEntity profitAndLossEntity, InternalContext internalContext) {
    ...
    private static void updateFinancialReport1(FinancialReport financialReport, InternalContext internalContext) {
    ...
    private static void updateReportMetadata1(ReportModel metadata, InternalContext internalContext) {
        metadata.setPurchasePrice(metadata.getPurchasePrice() + internalContext.getPurchasePrice());
        metadata.setSellPrice(metadata.getSellPrice() + internalContext.getSellPrice());
        metadata.setProfit(metadata.getProfit() + internalContext.getProfit());
        metadata.setBrokerCharges(metadata.getBrokerCharges() + internalContext.getBrokerCharges());
