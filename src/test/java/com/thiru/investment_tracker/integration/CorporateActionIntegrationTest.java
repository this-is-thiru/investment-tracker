...
public class CorporateActionIntegrationTest extends AbstractIntegrationTest {
    ...
    void addCorporateActionDEMERGER_whenMismatchedRatiosVsStocksCount_throwsException() {
        ...
        assertEquals("Demerger ratios must have one more element than the number of demerger stocks", exception.getMessage());
    }
    ...
    void deleteCorporateActions_whenNotSuperUser_forbidden() {
        ...
        given()
                .header("Authorization", "Bearer " + token)
                .when()
                .delete("/corporate-action/delete/" + id)
                .then()
    ...
    void deleteCorporateActions_whenSuperUser_success() {
        ...
        given()
                .header("Authorization", "Bearer " + token)
                .when()
                .delete("/corporate-action/delete/" + saved.getId())
                .then()
    ...
    void performPendingCorporateActions_whenInvalidMonth_throwsException() {
        ...
        assertEquals("Invalid month: INVALID", exception.getMessage());
    }
    ...
    void performPendingCorporateActions_whenTempTransactionsBeforeRecordDate_skips() {
        ...
        tempTransaction.setStatus(com.thiru.investment_tracker.dto.enums.TransactionStatus.TEMPORARY);
    ...
    void processBonusSharesTxns_multipleNewTransactionIds_throwsException() {
        ...
        // WHEN / THEN - processing bonus shares with multiple transactions creates multiple newTransactionIds
        assertThrows(IllegalArgumentException.class,
                () -> corporateActionService.processBonusShares("test@example.com", ca, BrokerName.UPSTOX, List.of(asset1, asset2)));
    }
